      ...
      <div className='offcanvasWrapper'>
        <div className='offcanvasInnerContent'>
          ...
          <div className='header_top_right list-unstyled'>
            <ul>
              <li>
                <i className='fa fa-phone' /> +234 567 234 875
              </li>
              <li>
                <i className='fa fa-envelope' /> info@yourdomain.com
              </li>
              <li>
                <i className='fa fa-globe' /> 1st Avenue, Boston
              </li>
            </ul>
          </div>
